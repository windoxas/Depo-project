...
const [selectName, setSelectName] = React.useState(localStorage.getItem('selectNames1074'))
const [countUp, setCountUp] = React.useState()
const [countDown, setCountDown] = React.useState();
const [selectOne, setSelectOne] = React.useState(localStorage.getItem('selectOne1074'))
const [selectTwo, setSelectTwo] = React.useState(localStorage.getItem('selectTwo1074'))
const [date, setDate] = React.useState(localStorage.getItem('getDateTwo1074'))
const [time, setTime] = React.useState(localStorage.getItem('getTimeTwo1074'))
const [endData, setEndData] = React.useState(localStorage.getItem('endDateTwo1074'))
const [endTime, setEndTime] = React.useState(localStorage.getItem('endTimeTwo1074'))


localStorage.setItem('selectNames1074', selectName)
localStorage.setItem('selectOne1074', selectOne)
localStorage.setItem('selectTwo1074', selectTwo)
localStorage.setItem('getDateTwo1074', date)
localStorage.setItem('getTimeTwo1074', time)
localStorage.setItem('endTimeTwo1074', endTime)
localStorage.setItem('endDateTwo1074', endData)

function selectOneOption(e){                        
    clearInterval(timerRefTwo.current)
    localStorage.removeItem('countUpTwo1074')
...
React.useEffect(() => {
    let hour = 0;
    let minuet = 0;
    let second = localStorage.getItem('countUpTwo1074')
  const countUpTime = () =>{
        localStorage.setItem('countUpTwo1074', second)
...
let getStateChangeSelectTrainName = Number(localStorage.getItem('selectNames1074'))
    ...
    return(
        ...
        <div className="list_person">
                ...
                <h3 className="teacher_train">Инструктор: Темиров Х</h3>
                    <h1 className="train_number">2ТЭ10М-1074</h1>
