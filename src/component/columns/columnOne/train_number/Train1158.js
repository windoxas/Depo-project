...
const [selectName, setSelectName] = React.useState(localStorage.getItem('selectNames1158'))
const [countUp, setCountUp] = React.useState()
const [countDown, setCountDown] = React.useState();
const [selectOne, setSelectOne] = React.useState(localStorage.getItem('selectOne1158'))
const [selectTwo, setSelectTwo] = React.useState(localStorage.getItem('selectTwo1158'))
const [date, setDate] = React.useState(localStorage.getItem('getDateTwo1158'))
const [time, setTime] = React.useState(localStorage.getItem('getTimeTwo1158'))
const [endData, setEndData] = React.useState(localStorage.getItem('endDateTwo1158'))
const [endTime, setEndTime] = React.useState(localStorage.getItem('endTimeTwo1158'))


localStorage.setItem('selectNames1158', selectName)
localStorage.setItem('selectOne1158', selectOne)
localStorage.setItem('selectTwo1158', selectTwo)
localStorage.setItem('getDateTwo1158', date)
localStorage.setItem('getTimeTwo1158', time)
localStorage.setItem('endTimeTwo1158', endTime)
localStorage.setItem('endDateTwo1158', endData)

function selectOneOption(e){                        
    clearInterval(timerRefTwo.current)
    localStorage.removeItem('countUpTwo1158')
...
React.useEffect(() => {
    let hour = 0;
    let minuet = 0;
    let second = localStorage.getItem('countUpTwo1158')
  const countUpTime = () =>{
        localStorage.setItem('countUpTwo1158', second)
...
React.useEffect(() => {
    let hours = {
        hourDown:10,
        MinutDown:45,
        SecondDown:localStorage.getItem('countDownTwo1158')
    }
    function countUpTime(){
        localStorage.setItem('countDownTwo1158', hours.SecondDown)
...
let getStateChangeSelectTrainName = Number(localStorage.getItem('selectNames1158'))
    ...
    return(
        ...
        <div className="list_person">
                ...
                <h3 className="teacher_train">Инструктор: Мамаев Ф</h3>
                    <h1 className="train_number">2ТЭ10М-1158</h1>
